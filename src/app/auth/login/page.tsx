...
export const metadata: Metadata = {
    title: 'Login',
    description: 'Sign in to your AI Central account.'
};
                    ...
                    <form className='space-y-6'>
                        <div>
                            ...
                            <input
                                ...
                                autoComplete='email'
                                required
                                className='border-input focus:ring-ring focus:border-ring bg-background w-full rounded-md border px-3 py-2 shadow-sm focus:ring-1 focus:outline-none'
                        ...
                        <div className='flex items-center justify-between'>
                            <label className='flex items-center'>
                                ...
                                />
                                <span className='text-muted-foreground ml-2 text-sm'>Remember me</span>
                            </label>
